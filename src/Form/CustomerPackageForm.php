...
class CustomerPackageForm extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options){
        ...
        ->add('useDefaultAddress', CheckboxType::class, ['label' => 'Use Default Address? ', 'required' => false, 'attr'=>['onclick'=>'useAddress();']])
